  ...
  return (
    <main className="max-w-7xl mx-auto px-4 py-8 overflow-x-hidden">
      ...
      <div className="relative">
        ...
        <div
          className="relative z-20 w-full max-w-[80vw] mx-auto transform sm:-rotate-1 bg-white border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] p-6 sm:p-8 my-10 sm:my-16"
